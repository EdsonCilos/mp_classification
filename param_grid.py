...
def classical_grid():
    ...
    logistic_regression_1 = _base_dic(LogisticRegression(
        solver='newton-cg',
        penalty='l2',
        multi_class = 'auto',
        random_state = seed))
    ...
    logistic_regression_2 = _base_dic(LogisticRegression(
        solver = 'liblinear',
        penalty = 'l1',
        multi_class='auto',
        random_state = seed))
    ...
    logistic_regression_3 = _base_dic(LogisticRegression(
        solver = 'saga',
        penalty = 'elasticnet',
        multi_class='auto',
        random_state = seed))
    ...
    svc_1 = _base_dic(SVC(kernel = 'linear', 
                         probability=True, 
                         random_state = seed))
    
    svc_1["estimator__C"] = c_list.copy()

    svc_2 = _base_dic(SVC(probability=True, random_state = seed))
